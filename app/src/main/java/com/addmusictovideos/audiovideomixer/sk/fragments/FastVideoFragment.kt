...
class FastVideoFragment : Fragment() {
    private lateinit var videoPath: String
    private lateinit var binding: FragmentFastVideoBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentFastVideoBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.ivBack.setOnClickListener {
            val action = FastVideoFragmentDirections.actionNavSpeedToNavAllVideo()
        ...
        val radioGroups = listOf(binding.radioGroup2)

        val radioButtons = listOf(
            binding.rb125x, binding.rb15x, binding.rb175x, binding.rb2x
        )
