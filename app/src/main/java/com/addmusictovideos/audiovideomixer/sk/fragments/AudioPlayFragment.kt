...
import com.addmusictovideos.audiovideomixer.sk.databinding.FragmentAudioPlayBinding
...
class AudioPlayFragment : Fragment() {
    ...
    private lateinit var binding: FragmentAudioPlayBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val args = AudioPlayFragmentArgs.fromBundle(requireArguments())
        audioPath = args.path
        ...
        requireActivity().onBackPressedDispatcher.addCallback(
            ...
            object : OnBackPressedCallback(true) {
                override fun handleOnBackPressed() {
                    ...
                    val action = AudioPlayFragmentDirections.actionAudioplayerToAllaudio("audio")
