...
import com.addmusictovideos.audiovideomixer.sk.databinding.FragmentCutAudioBinding
import com.addmusictovideos.audiovideomixer.sk.fragments.SpeedBottomSheet
import com.addmusictovideos.audiovideomixer.sk.fragments.VolumeBottomSheet
import com.addmusictovideos.audiovideomixer.sk.utils.AudioTrimmerView
import com.google.android.material.bottomnavigation.BottomNavigationView
import java.util.concurrent.TimeUnit


class CutAudioFragment : Fragment(), SpeedBottomSheet.OnSpeedSelectedListener,
    VolumeBottomSheet.OnVolumeSelectedListener {
    private lateinit var binding: FragmentCutAudioBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCutAudioBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        audioPath = CutAudioFragmentArgs.fromBundle(requireArguments()).audioPath
        ...
        binding.ivBack.setOnClickListener {
            val action = CutAudioFragmentDirections.actionNavCutaudioToAllaudios(null)
        ...
        binding.btnSaveVideo.setOnClickListener {
            ...
            val action = CutAudioFragmentDirections.actionTrimaudioToNavTrimaudioprogress(
                audioPath,
    ...
    private fun parseTimeToMilliseconds(timeString: String): Long {
        ...
        return (((minutes * 60) + seconds) * 1000L).toLong()
    }
    ...
    private fun stopAudio() {
        mediaPlayer?.let {
            it.pause()
            it.seekTo(startTrimMs.toInt()) // Restart from trimmed start
            isplaying = false
